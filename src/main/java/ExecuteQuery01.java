...
public class ExecuteQuery01 {
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        //RECORDLARI GORMEK ICIN ExecuteQuery01() metodunu kullanmaliyiz
        ResultSet resultSet1 = st.executeQuery(sql1);
        while (resultSet1.next()) {
            System.out.println(resultSet1.getString("country_name"));// buraya sutunun adi yazilir ya da numarasi
        }
        System.out.println("----------------");
